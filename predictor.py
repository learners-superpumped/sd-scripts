...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        style_data: str = Input(
            description="for second concept",
            default=None
        ),
        ...
        num_repeat_ins: int = Input(
            description="repeat number of instance data",
            default=1
        ),
        num_repeat_sty: int = Input(
            description="repeat number of style data",
            default=1
        ),
        extra: str = Input(
        ...
        prior_loss_w: float = Input(
            description="prior loss weight",
            default=1.0
        ),
        network_module:str = Input(
            description="Network module to use",
            default=None
        ),
        network_algo: str = Input(
            description="network algorithm to use",
            default="locon"
        )
    ) -> TrainingOutput:
        start = time.time()
